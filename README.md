...
- _**How to Interact with the Work**_
    - This project features _**two interaction methods:**_
        ...
        ```
        2. **Sound Input:** (My main interaction method)
...
- In the group version, the key interactivity—click-to-start audio and audio-reactive text—had been removed. I reimplemented:
...
- The titles _"Pacman"_ and _"* PIET"_ were converted into vector dot-point arrays via `font.textToPoints()`, and each point is rendered with `ellipse()` and a glowing shadow blur effect.
